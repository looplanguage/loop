...
mod tests {
    ...
    fn logical_operators_and() {
        ...
        test_jit("true and true and true and true", Object::Integer(Integer { value: 1 }));
        test_jit("(true and false) and true and true and (true and true)", Object::Integer(Integer { value: 0 }));
        test_jit("(true and true) and true and true and (true and true)", Object::Integer(Integer { value: 1 }));
    }
    ...
    fn logical_operators_or() {
        ...
        test_jit("(true or false) or (false or true or false or false)", Object::Integer(Integer { value: 1 }));
    }

    #[test]
    fn logical_operators_combined() {
        test_jit("((true or false) and (true and false)) or true", Object::Integer(Integer { value: 1 }));
        test_jit("((true or false) and (true and false)) and true", Object::Integer(Integer { value: 0 }));
    }
