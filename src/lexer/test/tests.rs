...
mod tests {
    ...
    fn variable_declaration_numbers() {
        let input =
            "var test = 1; var _foo = 1.1; var bar = -1; var yeet = 1.1; var yeet2 = -0.0002; var hello_world_2 = 3;";
        let expected = vec![
            // Statement 1
            ...
            test_helper::generate_token("=", TokenType::Assign),
            test_helper::generate_token("1.1", TokenType::Float), // CHANGE THIS BACK LATER (to 1.1 and Float)
            test_helper::generate_token(";", TokenType::Semicolon),
            // Statement 3
            test_helper::generate_token("var", TokenType::VariableDeclaration),
            ...
            test_helper::generate_token("=", TokenType::Assign),
            test_helper::generate_token("-", TokenType::Minus),
            test_helper::generate_token("0.0002", TokenType::Float), // CHANGE THIS BACK LATER (to -0.0001 and Float)
            test_helper::generate_token(";", TokenType::Semicolon),
            // Statement 6
            test_helper::generate_token("var", TokenType::VariableDeclaration),
